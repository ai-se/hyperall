...
def run_experiment_all(train, test, perf_measure=None):
    ...
    automl = autosklearn.classification.AutoSklearnClassifier(
        ...
        per_run_time_limit=30,
        tmp_folder='/Users/viveknair/GIT/hyperall/tmp2/autosklearn_cv_example_tmp',
        output_folder='/Users/viveknair/GIT/hyperall/tmp2/autosklearn_cv_example_out',
        delete_tmp_folder_after_terminate=False,
        resampling_strategy='cv',
        resampling_strategy_arguments={'folds': 3}
    )
...
if __name__ == '__main__':
    ...
    for project in projects:
        ...
        for rep in range(20):
            ...
            pickle.dump(results,
                        open('./PickleLocker/' + project.replace(data_folder, '')[:-1] + '_' + str(rep) + '.p', 'wb'))
